...
def run_core_integrator(
    ...
    *,
    ...
    self_consistency_convergence_mode: str = "dual_independent",
    self_consistency_target_ms_tolerance: float = 1e-6,
    self_consistency_target_gamma_tolerance: float = 1e-6,
    ...
    self_consistency_dual_weight: float = 0.5,
    ...
    if self_consistency_enabled:
        self_consistency = SelfConsistencyConfig(
            ...
            target_gamma_tolerance=self_consistency_target_gamma_tolerance,
            ...
            dual_weight=self_consistency_dual_weight,
...
def run_benchmark(
    *,
    ...
    core_results = run_core_integrator(
        ...
        self_consistency_target_gamma_tolerance=self_consistency_target_gamma_tolerance,
        ...
        self_consistency_dual_weight=self_consistency_dual_weight,
