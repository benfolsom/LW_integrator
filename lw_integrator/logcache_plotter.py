"""Packaged live plotter for sweep logcache data.
...
Usage:
    ...
    python -m lw_integrator.logcache_plotter --live [logfile]

    # Single plot (like original):
    python -m lw_integrator.logcache_plotter [logfile]

    # Live mode with custom refresh interval:
    python -m lw_integrator.logcache_plotter --live --interval 5 [logfile]

    # Filter out extreme gains (default: ±30%):
    python -m lw_integrator.logcache_plotter --max-gain 50 [logfile]
"""
