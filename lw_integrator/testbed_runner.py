...
Scalar potential term q·Φ = -0.000000000000000e+00
     Mass-shell violation |γ_conjugate - γ_mass_shell| = 0.000000000000000e+00
     Newly computed β: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01
     γ_velocity (from β over Δt=8.157115363212585e+06) = 9.763936420934931e+05, βtot=9.999999999994755e-01
   Step 748, Particle 0: max iter (5) reached
     Mass-shell error = 1.000000000000000e+00
     Position: x=4.001926e+03 mm, y=-4.941291e+02 mm, z=1.187751e+13 mm
     Time: t=3.962520e+10 ns
     γ_velocity (from β)        = 9.763936420934931e+05
     γ_energy   (from Pt - q·Φ) = 5.797294601393307e+18
     γ_mass_shell (√(P²+(mc)²)/(mc)) = 5.797294601393307e+18
   ⚠️  Final mass-shell projection: Pt 9.534238e+17 → 9.534238e+17 (error was 1.00e+00)
     Force contributions: ΔPx=0.000000000000000e+00, ΔPy=0.000000000000000e+00, ΔPz=0.000000000000000e+00, ΔPt=0.000000000000000e+00
     Using particle_beta=(3.369330514260738e-10, -4.160207617561853e-11, 9.999999999994755e-01), gamma=5.797294601393307e+18
     Newly computed β: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01
   Particle 0 iteration 1: Starting refinement
     Working state: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01, γ=5.797294601393307e+18
     result[bx]=3.369330514260738e-10, result[bz]=9.999999999994755e-01
     Force contributions: ΔPx=0.000000000000000e+00, ΔPy=0.000000000000000e+00, ΔPz=0.000000000000000e+00, ΔPt=0.000000000000000e+00
     Using particle_beta=(3.369330514260738e-10, -4.160207617561853e-11, 9.999999999994755e-01), gamma=5.797294601393307e+18
     After forces: ΔPt=0.000000000000000e+00, accumulated_pt=9.534237620494237e+17
     Mode: fixed_geometry, Pt_ms=9.534238e+17
     After relaxation (α=0.7): Pt 9.534238e+17 → 9.534238e+17 (Δ=0.000000e+00)
     After relaxation (α=0.7): Pt 9.534238e+17 → 9.534238e+17 (Δ=0.000000e+00)
     γ_energy (Pt - q·Φ)/(mc) = 5.797294601393307e+18
     γ_conjugate (Pt/(mc), before projection) = 5.797294601393307e+18
     γ_mass_shell (√(P²+(mc)²)/(mc)) = 5.797294601393307e+18
     Scalar potential term q·Φ = -0.000000000000000e+00
     Mass-shell violation |γ_conjugate - γ_mass_shell| = 0.000000000000000e+00
     Newly computed β: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01
     γ_velocity (from β over Δt=8.157115363212585e+06) = 9.763936420934931e+05, βtot=9.999999999994755e-01
   Particle 0 iteration 2: Starting refinement
     Working state: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01, γ=5.797294601393307e+18
     result[bx]=3.369330514260738e-10, result[bz]=9.999999999994755e-01
     Force contributions: ΔPx=0.000000000000000e+00, ΔPy=0.000000000000000e+00, ΔPz=0.000000000000000e+00, ΔPt=0.000000000000000e+00
     Using particle_beta=(3.369330514260738e-10, -4.160207617561853e-11, 9.999999999994755e-01), gamma=5.797294601393307e+18
     ...
     Newly computed β: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01
     γ_velocity (from β over Δt=8.157115363212585e+06) = 9.763936420934931e+05, βtot=9.999999999994755e-01
   Particle 0 iteration 3: Starting refinement
     Working state: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01, γ=5.797294601393307e+18
     result[bx]=3.369330514260738e-10, result[bz]=9.999999999994755e-01
     Force contributions: ΔPx=0.000000000000000e+00, ΔPy=0.000000000000000e+00, ΔPz=0.000000000000000e+00, ΔPt=0.000000000000000e+00
     Using particle_beta=(3.369330514260738e-10, -4.160207617561853e-11, 9.999999999994755e-01), gamma=5.797294601393307e+18
     ...
     Newly computed β: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01
     γ_velocity (from β over Δt=8.157115363212585e+06) = 9.763936420934931e+05, βtot=9.999999999994755e-01
   Particle 0 iteration 4: Starting refinement
     Working state: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01, γ=5.797294601393307e+18
     result[bx]=3.369330514260738e-10, result[bz]=9.999999999994755e-01
     Force contributions: ΔPx=0.000000000000000e+00, ΔPy=0.000000000000000e+00, ΔPz=0.000000000000000e+00, ΔPt=0.000000000000000e+00
     Using particle_beta=(3.369330514260738e-10, -4.160207617561853e-11, 9.999999999994755e-01), gamma=5.797294601393307e+18
   ...
   Step 748, Particle 0: max iter (5) reached
     Mass-shell error = 1.000000000000000e+00
     Position: x=4.002750e+03 mm, y=-4.942308e+02 mm, z=1.187996e+13 mm
     Time: t=3.963336e+10 ns
     γ_velocity (from β)        = 9.763936420934931e+05
     γ_energy   (from Pt - q·Φ) = 5.797294601393307e+18
     γ_mass_shell (√(P²+(mc)²)/(mc)) = 5.797294601393307e+18
   ⚠️  Final mass-shell projection: Pt 9.534238e+17 → 9.534238e+17 (error was 1.00e+00)
   ...
   Step 748, Particle 0: max iter (5) reached
     Mass-shell error = 1.000000000000000e+00
     Position: x=4.003574e+03 mm, y=-4.943325e+02 mm, z=1.188240e+13 mm
     Time: t=3.964151e+10 ns
     γ_velocity (from β)        = 9.763936420934931e+05
     γ_energy   (from Pt - q·Φ) = 5.797294601393307e+18
     γ_mass_shell (√(P²+(mc)²)/(mc)) = 5.797294601393307e+18
   ⚠️  Final mass-shell projection: Pt 9.534238e+17 → 9.534238e+17 (error was 1.00e+00)
   ...
   Step 748, Particle 0: max iter (5) reached
     Mass-shell error = 1.000000000000000e+00
     Position: x=4.004398e+03 mm, y=-4.944343e+02 mm, z=1.188485e+13 mm
     Time: t=3.964967e+10 ns
     γ_velocity (from β)        = 9.763936420934931e+05
     γ_energy   (from Pt - q·Φ) = 5.797294601393307e+18
     γ_mass_shell (√(P²+(mc)²)/(mc)) = 5.797294601393307e+18
   ⚠️  Final mass-shell projection: Pt 9.534238e+17 → 9.534238e+17 (error was 1.00e+00)
   ...
   Step 748, Particle 0: max iter (5) reached
     Mass-shell error = 1.000000000000000e+00
     Position: x=4.005221e+03 mm, y=-4.945360e+02 mm, z=1.188729e+13 mm
     Time: t=3.965783e+10 ns
     γ_velocity (from β)        = 9.763936420934931e+05
     γ_energy   (from Pt - q·Φ) = 5.797294601393307e+18
     γ_mass_shell (√(P²+(mc)²)/(mc)) = 5.797294601393307e+18
   ⚠️  Final mass-shell projection: Pt 9.534238e+17 → 9.534238e+17 (error was 1.00e+00)
   ...
   Particle 0 iteration 3: Starting refinement
     Working state: βx=3.369330514260738e-10, βy=-4.160207617561853e-11, βz=9.999999999994755e-01, γ=5.797294601393307e+18
     result[bx]=3.369330514260738e-10, result[bz]=9.999999999994755e-01from core.debug_logger import get_current_log_path, initialize_debug_logging
