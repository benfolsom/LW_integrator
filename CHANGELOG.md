...
- **Scale validation** — Recent local pseudo-only long-stability probes through `N=32768`, `K=8,16`, `96` steps stayed finite, including retarded same-bunch space-charge cases. Medium validation matrices remained finite with max comparison deltas around `5.45e-05 mm`, `4.34e-05 mm`, and `7.22e-06` in gamma for the tested small-reference cases.
