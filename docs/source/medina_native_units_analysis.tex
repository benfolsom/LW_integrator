...
momentum, may change both direction and magnitude, and requires a clean
\(\mathbf{F}_{\mathrm{ext}}\) extraction API before implementation.
\end{description}
...
should start with prescribed-field benchmarks before being applied to retarded
